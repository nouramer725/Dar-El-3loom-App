...
class ProfilePictureTeacherWidget extends StatefulWidget {
  const ProfilePictureTeacherWidget({super.key});

  @override
  State<ProfilePictureTeacherWidget> createState() =>
      _ProfilePictureTeacherWidgetState();
}

class _ProfilePictureTeacherWidgetState
    extends State<ProfilePictureTeacherWidget> {
  File? selectedImage;
  ...
  Future<void> uploadProfilePicture() async {
    ...
    try {
      ...
      final response = await api.uploadProfilePictureTeacher(selectedImage!);
