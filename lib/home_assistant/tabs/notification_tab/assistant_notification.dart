...
class AssistantNotification extends StatefulWidget {
  const AssistantNotification({super.key});

  @override
  State<AssistantNotification> createState() => _AssistantNotificationState();
}

class _AssistantNotificationState extends State<AssistantNotification> {
  bool isLoading = true;
