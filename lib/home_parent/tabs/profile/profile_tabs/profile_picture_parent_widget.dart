...
class ProfilePictureParentWidget extends StatefulWidget {
  const ProfilePictureParentWidget({super.key});

  @override
  State<ProfilePictureParentWidget> createState() =>
      _ProfilePictureParentWidgetState();
}

class _ProfilePictureParentWidgetState
    extends State<ProfilePictureParentWidget> {
  File? selectedImage;
